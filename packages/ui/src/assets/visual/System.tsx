...
const SvgSystem = (props: SvgProps) => (
  <Svg fill="none" viewBox="0 0 60 60" {...props}>
    <G clip-path="url(#a)">
      ...
      />
      <Circle cx="23" cy="23" r="6" fill="#794CFF" stroke="#fff" stroke-width="2" />
      <Circle cx="41" cy="41" r="4" fill="#794CFF" stroke="#fff" stroke-width="2" />
    </G>
    <Defs>
      <ClipPath id="a">

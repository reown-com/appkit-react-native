import { type CaipNetworkId, type SIWXMessage } from '@reown/appkit-common-react-native';
import { ConnectionsController } from '@reown/appkit-core-react-native';

import { SIWXMessenger } from '../core/SIWXMessenger';
...
export class InformalMessenger extends SIWXMessenger {
  ...
  protected getNetworkName(chainId: CaipNetworkId): string | undefined {
    ...
    return requestedNetworks.find(network => network.caipNetworkId === chainId)?.name;
  }
